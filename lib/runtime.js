...
{
    return !!(object && object.constructor["$ns_name"]);
}
...
{
    if (cls && cls["$ns_name"]) {
        return _getReadableForRawName(cls["$ns_name"]);
    }
...
BaseObject.prototype.description = function() { return "<" + this.className() + " " + this["$ns_id"] + ">" }
...
if (typeof module != "undefined" && typeof module != "function") {
    ...
    if (typeof global != "undefined" && typeof global != "function") {
        global["$ns_ns"] = nilscript;
    }

} else if (typeof define === "function" && define.amd) {
    define(nilscript);
} else {
    root.nilscript = root["$ns_ns"] = nilscript;
}
