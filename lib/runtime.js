...
var _classSymbolToSuperSymbolMap = { };
var _classSymbolToClassMap       = { BaseObject: BaseObject };
...
function _reset()
{
    ...
    clear(_classSymbolToSuperSymbolMap);

    _classSymbolToClassMap["BaseObject"] = BaseObject;
}
...
function _registerClass(classSymbol, superSymbol, callback)
{
    ...
    if (!superSymbol) {
        superSymbol = "BaseObject";
        isSubclassOfBase = true;
    }

    var cls;

    _classSymbolToSuperSymbolMap[classSymbol] = superSymbol;
...
function getSubclassesOfClass(cls)
{
    ...
    for (var key in _classSymbolToSuperSymbolMap) { if (hop(_classSymbolToSuperSymbolMap, key)) {
        var superName = _classSymbolToSuperSymbolMap[key];
