...
function _registerCategory(classNameObject, callback)
{
    ...
    _callWhenClassReady(className, function() {
        ...
        mixin(class_methods, cls, true, function(key, method) {
            method.displayName = _getMethodDisplayName(className, key, "+");
        });
...
function _registerClass(nameObject, superObject, callback)
{
    ...
    _callWhenClassReady(superName, function() {
        ...
        cls.displayName = _getReadableForRawName(name);
        cls[_nameKey]  = name;
        ...
        mixin(class_methods, cls, true, function(key, method) {
            method.displayName = _getMethodDisplayName(name, key, "+");
        });
...
{
    return _getReadableForRawName(_getRawName(selector));
}
...
{
    if (cls && cls[_nameKey]) {
        return _getReadableForRawName(cls[_nameKey]);
    }
...
BaseObject.prototype.performSelector_ = function(aSelector) { return nilscript.msgSend(this, aSelector); }
BaseObject.prototype.performSelector_withObject_ = function(aSelector, object) { return nilscript.msgSend(this, aSelector, object); }
BaseObject.prototype.performSelector_withObject_withObject_ = function(aSelector, o1, o2) { return nilscript.msgSend(this, aSelector, o1, o2); }
...
if (typeof module != "undefined" && typeof module != "function") {
    ...
    if (typeof global != "undefined" && typeof global != "function") {
        global["N$_nilscript"] = nilscript;
    }

} else if (typeof define === "function" && define.amd) {
    define(nilscript);
} else {
    root.nilscript = root["N$_nilscript"] = nilscript;
}
