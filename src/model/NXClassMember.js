...
export class NXGetMember {
    constructor(location, isStatic, name, type)
    {
        
    }
}

export class NXSetMember {
    constructor(location, isStatic, name, type)
    {
...
export class NXFuncMember {

}

export class NXPropMember {

}


export class NXFieldMember {
...
export class NXClassMember {

constructor(location, isStatic, kind, name, type)
{
